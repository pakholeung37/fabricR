...
const StaticCanvas = createClass(
  ...
  /** @lends StaticCanvas.prototype */ {
     ...
     * Should be set via {@link StaticCanvas#setBackgroundColor}.
     ...
     * Should be set via {@link StaticCanvas#setOverlayColor}
     * @since 1.3.9
     * @type {(String|fabric.Pattern)}
     * @default
     */
     ...
     * @memberOf StaticCanvas.prototype
     */
    vptCoords: {},
    ...
    /**
     * Sets {@link StaticCanvas#overlayImage|overlay image} for this canvas
     * @param {(Image|String)} image Image instance or URL of an image to set overlay to
     * @param {Function} callback callback to invoke when image is loaded and set as an overlay
     * @param {Object} [options] Optional options to set for the {@link Image|overlay image}.
     ...
     * Image.fromURL('http://fabricjs.com/assets/jail_cell_bars.png', function(img, isError) {
    ...
    /**
     * Sets {@link StaticCanvas#backgroundImage|background image} for this canvas
     * @param {(Image|String)} image Image instance or URL of an image to set background to
     * @param {Function} callback Callback to invoke when image is loaded and set as background
     * @param {Object} [options] Optional options to set for the {@link Image|background image}.
     * @return {fabric.Canvas} thisArg
     * @chainable
     ...
     * Image.fromURL('http://fabricjs.com/assets/honey_im_subtle.png', function(img, isError) {
     *    img.set({width: canvas.width, height: canvas.height, originX: 'left', originY: 'top'});
    ...
    /**
     * Sets {@link StaticCanvas#overlayColor|foreground color} for this canvas
    ...
    /**
     * Sets {@link StaticCanvas#backgroundColor|background color} for this canvas
    ...
    /**
     * @private
     * @param {String} property Property to set ({@link StaticCanvas#backgroundImage|backgroundImage}
     * or {@link StaticCanvas#overlayImage|overlayImage})
     * @param {(Image|String|null)} image Image instance, URL of an image or null to set background or overlay to
     ...
     * @param {Object} [options] Optional options to set for the {@link Image|image}.
     */
    ...
    /**
     * @private
     * @param {String} property Property to set ({@link StaticCanvas#backgroundColor|backgroundColor}
     * or {@link StaticCanvas#overlayColor|overlayColor})
    ...
    createSVGClipPathMarkup: function (options) {
      var clipPath = this.clipPath
      if (clipPath) {
        clipPath.clipPathId = "CLIPPATH_" + FaObject.__uid++
        return (
          '<clipPath id="' +
          clipPath.clipPathId +
          '" >\n' +
 ...
 * var json = canvas.toJSON();
 */
StaticCanvas.prototype.toJSON = StaticCanvas.prototype.toObject
...
if (fabric.isLikelyNode) {
  ...
  StaticCanvas.prototype.createJPEGStream = function (opts) {
    var impl = getNodeCanvas(this.lowerCanvasEl)
...
// TODO
getGlobalThis().fabric.StaticCanvas = StaticCanvas
