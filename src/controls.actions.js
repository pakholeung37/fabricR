 ...
 */
export function findCornerQuadrant(fabricObject, control) {
  var cornerAngle =
    fabricObject.angle +
 ...
 */
export function scaleCursorStyleHandler(eventData, control, fabricObject) {
 ...
 * @return {String} a valid css string for the cursor
 */
export function skewCursorStyleHandler(eventData, control, fabricObject) {
  var notAllowed = "not-allowed"
 ...
 * @private
 */
export function compensateScaleForSkew(
  target,
  oppositeSkew,
  scaleToCompoensate,
  axis,
 ...
 * @private
 */
export function skewObjectX(eventData, transform, x, y) {
  var target = transform.target,
 ...
 */
export function skewHandlerX(eventData, transform, x, y) {
