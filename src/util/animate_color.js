 ...
 * @param {Function} [options.colorEasing] Easing export function. Note that this export function only take two arguments (currentTime, duration). Thus the regular animation easing export functions cannot be used.
