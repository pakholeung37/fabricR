 ...
 * @see {@link Pattern#initialize} for constructor definition
 */

const Pattern = createClass(
  /** @lends Pattern.prototype */ {
    /**
    ...
    toObject: function (propertiesToInclude) {
      var NUM_FRACTION_DIGITS = FaObject.NUM_FRACTION_DIGITS,
        source,
        object
...
// TODO
getGlobalThis().fabric.Pattern = Pattern
