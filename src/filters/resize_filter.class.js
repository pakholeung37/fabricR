 ...
 * @example
 * var filter = new Resize();
 * object.filters.push(filter);
 * object.applyFilters(canvas.renderAll.bind(canvas));
 */
const Resize = createClass(
  BaseFilter,
  /** @lends Resize.prototype */ {
    /**
     * Filter type
     * @param {String} type
     * @default
 ...
 * @return {Resize} Instance of Resize
 */
Resize.fromObject = BaseFilter.fromObject

export default Resize
export function setup() {
  Image.filters.Resize = Resize
}
