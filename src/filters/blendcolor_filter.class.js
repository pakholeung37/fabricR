...
const BlendColor = createClass(
  BaseFilter,
  /** @lends Blend.prototype */ {
    type: "BlendColor",
 ...
 * @return {BlendColor} Instance of BlendColor
 */
BlendColor.fromObject = BaseFilter.fromObject

export default BlendColor
export function setup() {
  Image.filters.BlendColor = BlendColor
}
