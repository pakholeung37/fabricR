 ...
 * @extends BaseFilter
 * @see {@link MyFilter#initialize} for constructor definition
 ...
 * object.applyFilters();
 */
const MyFilter = createClass(
  BaseFilter,
  /** @lends MyFilter.prototype */ {
    /**
     * Filter type
     * @param {String} type
     * @default
 ...
 * @return {MyFilter} Instance of MyFilter
 */
MyFilter.fromObject = BaseFilter.fromObject

export default MyFilter
export function setup() {
  Image.filters.MyFilter = MyFilter
}
