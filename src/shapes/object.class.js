 ...
 * @see {@link Object#initialize} for constructor definition
 *
 * @fires added
 * @fires removed
 *
  ...
  /** @lends Object.prototype */ {
    ...
    _limitCacheSize: function (dims) {
      ...
      if (
        width <= max &&
        height <= max &&
        width * height <= fabric.perfLimitSizeTotal
      ) {
        if (width < min) {
          dims.width = min
        }
      ...
      var ar = width / height,
        limitedDims = limitDimsByArea(ar, fabric.perfLimitSizeTotal),
    ...
    toObject: function (propertiesToInclude) {
      var NUM_FRACTION_DIGITS = Object.NUM_FRACTION_DIGITS,
        object = {
          type: this.type,
    ...
    _removeDefaultValues: function (object) {
      var prototype = getKlass(object.type).prototype,
      ...
      stateProperties.forEach(function (prop) {
        ...
        var isArray = _isArray(object[prop]) && _isArray(prototype[prop])
    ...
    clone: function (callback, propertiesToInclude) {
      ...
      if (this.constructor.fromObject) {
        ...
        Object._fromObject("Object", objectForm, callback)
      }
    },
    ...
    toCanvasElement: function (options) {
      ...
      if (shadow) {
        ...
        shadowOffset.x =
          2 * Math.round(abs(shadow.offsetX) + shadowBlur) * abs(scaling.scaleX)
        shadowOffset.y =
          2 * Math.round(abs(shadow.offsetY) + shadowBlur) * abs(scaling.scaleY)
      }
 ...
 * @type Number
 */
Object.NUM_FRACTION_DIGITS = 2

Object._fromObject = function (className, object, callback, extraParam) {
...
getGlobalThis().fabric.Object = Object
