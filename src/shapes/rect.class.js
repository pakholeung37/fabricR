 ...
 */
const Rect = createClass(
  Object,
  /** @lends Rect.prototype */ {
    /**
     * List of properties to consider when checking if state of an object is changed ({@link Object#hasStateChanged})
     * as well as for history (undo/redo) purposes
     * @type Array
     */
    stateProperties: Object.prototype.stateProperties.concat("rx", "ry"),
...
Rect.fromElement = function (element, callback, options) {
  ...
  var rect = new Rect(extend(options ? clone(options) : {}, parsedAttributes))
 ...
 * @param {Function} [callback] Callback to invoke when an Rect instance is created
 */
Rect.fromObject = function (object, callback) {
  return Object._fromObject("Rect", object, callback)
}

getGlobalThis().fabric.Rect = Rect
export default Rect
