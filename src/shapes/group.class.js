...
const Group = createClass(
  ...
  /** @lends Group.prototype */ {
    ...
    _set: function (key, value) {
      ...
      Object.prototype._set.call(this, key, value)
    },
    ...
    toObject: function (propertiesToInclude) {
      ...
      var obj = Object.prototype.toObject.call(this, propertiesToInclude)
    ...
    toDatalessObject: function (propertiesToInclude) {
      ...
      var obj = Object.prototype.toDatalessObject.call(
        this,
        propertiesToInclude
      )
      obj.objects = objsToObject
...
/**
 * Returns {@link Group} instance from an object representation
 * @static
 * @memberOf Group
...
Group.fromObject = function (object, callback) {
  ...
  enlivenObjects(objects, function (enlivenedObjects) {
    enlivenObjects([object.clipPath], function (enlivedClipPath) {
      var options = clone(object, true)
      options.clipPath = enlivedClipPath[0]
      delete options.objects
      callback && callback(new Group(enlivenedObjects, options, true))
    })
  })
}

getGlobalThis().fabric.Group = Group
