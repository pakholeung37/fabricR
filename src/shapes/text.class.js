...
const Text = createClass(
  ...
  /** @lends Text.prototype */ {
     ...
     * @type Array
     */
    stateProperties: Object.prototype.stateProperties.concat(
      "fontFamily",
      "fontWeight",
      "fontSize",
      "text",
 ...
 */
Text.ATTRIBUTE_NAMES = fabric.SHARED_ATTRIBUTES.concat(
 ...
 * @param {Object} [options] Options object
 */
Text.fromElement = function (element, callback, options) {
  if (!element) {
  ...
  if (!("fontSize" in options)) {
    options.fontSize = Text.DEFAULT_SVG_FONT_SIZE
  }
 ...
 * @param {Function} [callback] Callback to invoke when an Text instance is created
 */
Text.fromObject = function (object, callback) {
  return Object._fromObject("Text", object, callback, "text")
}

Text.genericFonts = ["sans-serif", "serif", "cursive", "fantasy", "monospace"]

createAccessors && createAccessors(Text)

getGlobalThis().fabric.Text = Text
export default Text
