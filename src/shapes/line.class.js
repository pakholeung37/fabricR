...
const Line = createClass(
  ...
  /** @lends Line.prototype */ {
    ...
    _renderDashedStroke: function (ctx) {
      ...
      ctx.beginPath()
      drawDashedLine(ctx, p.x1, p.y1, p.x2, p.y2, this.strokeDashArray)
      ctx.closePath()
    },
 ...
 */
Line.ATTRIBUTE_NAMES = fabric.SHARED_ATTRIBUTES.concat("x1 y1 x2 y2".split(" "))
...
Line.fromElement = function (element, callback, options) {
  ...
  callback(new Line(points, extend(parsedAttributes, options)))
}
/* _FROM_SVG_END_ */
 ...
 */
Line.fromObject = function (object, callback) {
  ...
  Object._fromObject("Line", options, _callback, "points")
}
...
getGlobalThis().fabric.Line = Line
export default Line
