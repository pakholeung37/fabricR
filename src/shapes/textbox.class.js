...
const Textbox = createClass(IText, Observable, {
   ...
   * @private
   */
  _dimensionAffectingProps: Text.prototype._dimensionAffectingProps.concat(
    "width"
  ),
  ...
  styleHas: function (property, lineIndex) {
    ...
    return Text.prototype.styleHas.call(this, property, lineIndex)
  },
  ...
  _wrapLine: function (_line, lineIndex, desiredWidth, reservedSpace) {
    ...
    for (var i = 0; i < words.length; i++) {
      ...
      word = splitByGrapheme ? words[i] : graphemeSplit(words[i])
  ...
  _splitTextIntoLines: function (text) {
    var newText = Text.prototype._splitTextIntoLines.call(this, text),
 ...
 * @param {Function} [callback] Callback to invoke when an Textbox instance is created
 */
Textbox.fromObject = function (object, callback) {
  return Object._fromObject("Textbox", object, callback, "text")
}

getGlobalThis().fabric.Textbox = Textbox
