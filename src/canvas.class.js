...
var abs = Math.abs,
  supportLineDash = StaticCanvas.supports("setLineDash"),
  STROKE_OFFSET = 0.5
 ...
 * @see {@link Canvas#initialize} for constructor definition
 *
...
const Canvas = createClass(
  ...
  /** @lends Canvas.prototype */ {
    ...
    _initInteractive: function () {
      ...
      this.freeDrawingBrush = PencilBrush && new PencilBrush(this)
    ...
    _drawSelection: function (ctx) {
      ...
      if (this.selectionDashArray.length > 1 && !supportLineDash) {
        ...
        FaObject.prototype._setLineDash.call(this, ctx, this.selectionDashArray)
        ctx.strokeRect(
    ...
    restorePointerVpt: function (pointer) {
      return transformPoint(pointer, invertTransform(this.viewportTransform))
    },
    ...
    dispose: function () {
      ...
      StaticCanvas.prototype.dispose.call(this)
      return this
    },
    ...
    setViewportTransform: function (vpt) {
      ...
      StaticCanvas.prototype.setViewportTransform.call(this, vpt)
    }
  }
)
...
for (var prop in StaticCanvas) {
  if (prop !== "prototype") {
    Canvas[prop] = StaticCanvas[prop]
  }
}

export default Canvas
// TODO
getGlobalThis().fabric.Canvas = Canvas
