;(function () {
  ...
  var lineCoordsCases = [
    ...
    {
      description:
        "equal smallest points when origin is left-top and line not offset",
      givenLineArgs: {
    ...
    {
      description:
        "equal half-dimensions when origin is center and line not offset",
      givenLineArgs: {
        points: [0, 0, 12.3, 34.5],
        options: {
          originX: "center",
    ...
    {
      description:
        "equal full dimensions when origin is right-bottom and line not offset",
      givenLineArgs: {
        points: [0, 0, 55, 18],
        options: {
          originX: "right",
    ...
    {
      description:
        "equal x2 and y2 for left-top origin when x1 and y1 are largest and line not offset",
      givenLineArgs: {
    ...
    {
      description:
        "equal half-dimensions for center-center origin when x1 and y1 are largest and line not offset",
      givenLineArgs: {
        points: [100, 200, 0, 0],
        options: {
          originX: "center",
    ...
    {
      description:
        "equal x1 and y1 for right-bottom origin when x1 and y1 are largest and line not offset",
      givenLineArgs: {
        points: [100, 200, 0, 0],
        options: {
          originX: "right",
