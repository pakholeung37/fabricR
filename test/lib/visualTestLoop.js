;(function (exports) {
  ...
  function getAssetName(filename) {
    ...
    return fabric.isLikelyNode
      ? localPath("/../visual", finalName)
      : getAbsolutePath("/test/visual" + finalName)
  }
  ...
  function getFixtureName(filename) {
    ...
    return fabric.isLikelyNode
      ? localPath("/..", finalName)
      : getAbsolutePath("/test" + finalName)
  }
  ...
  exports.visualTestLoop = function (QUnit) {
    ...
    return function testCallback(testObj) {
      ...
      fabric.StaticCanvas.prototype.requestRenderAll =
        fabric.StaticCanvas.prototype.renderAll
      ...
      QUnit.test(testName, function (assert) {
        ...
        code(fabricCanvas, function (renderedCanvas) {
          ...
          var imageDataCanvas = renderedCanvas
            .getContext("2d")
          ...
          getImage(getGoldeName(golden), renderedCanvas, function (
            goldenImage
          ) {
            ...
            var differentPixels = _pixelMatch(
              imageDataCanvas,
              imageDataGolden,
              output.data,
              width,
