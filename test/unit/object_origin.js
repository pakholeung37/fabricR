;(function () {
  ...
  QUnit.test("translateToCenterPointRotated", function (assert) {
    ...
    assert.deepEqual(
      p,
      new fabric.Point(39.090210326743936, -14.404385860137658)
    )
    ...
    assert.deepEqual(
      p,
      new fabric.Point(57.11155530110176, -1.7857042604146471)
    )

    p = rect.translateToCenterPoint(point, "right", "center")
    assert.deepEqual(
      p,
      new fabric.Point(-3.0213449743578202, 7.381318400276987)
    )
    ...
    assert.deepEqual(
      p,
      new fabric.Point(21.068865352386116, -27.02306745986067)
    )
  })
  ...
  QUnit.test("toLocalPointRotated", function (assert) {
    ...
    assert.deepEqual(
      p,
      new fabric.Point(-52.72245179455599, -51.00727238020387)
    )

    p = rect.toLocalPoint(point, "center", "top")
    assert.deepEqual(
      p,
      new fabric.Point(-52.72245179455599, -9.007272380203872)
    )

    p = rect.toLocalPoint(point, "center", "bottom")
    assert.deepEqual(
      p,
      new fabric.Point(-52.72245179455599, -93.00727238020387)
    )

    p = rect.toLocalPoint(point, "left", "center")
    assert.deepEqual(
      p,
      new fabric.Point(-30.722451794555987, -51.00727238020387)
    )

    p = rect.toLocalPoint(point, "left", "top")
    assert.deepEqual(
      p,
      new fabric.Point(-30.722451794555987, -9.007272380203872)
    )

    p = rect.toLocalPoint(point, "left", "bottom")
    assert.deepEqual(
      p,
      new fabric.Point(-30.722451794555987, -93.00727238020387)
    )
  ...
  QUnit.test("translateToCenterPointRotated with numeric origins", function (
    assert
  ) {
    var rect = new fabric.Rect(rectOptions),
      p,
  ...
  QUnit.test("translateToOriginPointRotated with numeric origins", function (
    assert
  ) {
    var rect = new fabric.Rect(rectOptions),
      p,
