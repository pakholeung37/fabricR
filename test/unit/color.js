;(function () {
  ...
  QUnit.test("fromRgba (percentage values with whitespaces)", function (
    assert
  ) {
    var originalRgba = "rgba( 100% , 100% , 100% , 0.5 )"
    var oColor = fabric.Color.fromRgba(originalRgba)
  ...
  QUnit.test("sourceFromRgb", function (assert) {
    ...
    assert.deepEqual(fabric.Color.sourceFromRgb("rgb(255,255,255)"), [
      255,
      255,
      255,
      1
    ])
    assert.deepEqual(fabric.Color.sourceFromRgb("rgb(100,150,200)"), [
      100,
      150,
      200,
      1
  ...
  QUnit.test("sourceFromHsl", function (assert) {
    ...
    assert.deepEqual(fabric.Color.sourceFromHsl("hsl(360,100%,100%)"), [
      255,
      255,
      255,
      1
    ])
    assert.deepEqual(fabric.Color.sourceFromHsl("hsl(180,50%,40%)"), [
      51,
      153,
      153,
      1
  ...
  QUnit.test("sourceFromHex", function (assert) {
    ...
    // uppercase
    assert.deepEqual(fabric.Color.sourceFromHex("#FFFFFF00"), [
      255,
      255,
      255,
      0
    ])
    assert.deepEqual(fabric.Color.sourceFromHex("#FFFFFFCC"), [
      255,
      255,
      255,
      0.8
    ])
    assert.deepEqual(fabric.Color.sourceFromHex("#FFFFFFFF"), [
      255,
      255,
      255,
      1
  ...
  QUnit.test("transparent", function (assert) {
    assert.deepEqual(new fabric.Color("transparent").getSource(), [
      255,
      255,
      255,
      0
